...
public class OperacionesInmobiliarias {
    ...
    private void MenuClientes(){
        ...
        while(check==false){
            ...
            ServiceSaveFile<Cliente> saveCliente = new ServiceSaveFile<>( "clientes.dat", this.inmobiliaria.getClientes() );
      ...
      private void MenuInmuebles(){
        ...
        while(check==false){
            ...
            ServiceSaveFile<Inmueble> saveInmueble = new ServiceSaveFile<>( "inmuebles.dat", this.inmobiliaria.getInmuebles() );
